...
import { Shield, Lock, Terminal as TerminalIcon, Wifi, Database, Code2, Github } from 'lucide-react'
import {
  LoginContainer,
  LeftSection,
  RightSection,
  ...
  return (
    <LoginContainer>
      <LeftSection>
        <Separator />
        <FormContainer>
          <Logo>OPS GLITCH</Logo>
          
          <FormTitle>Access Terminal</FormTitle>
          <FormSubtitle>
      ...
      <RightSection>
        ...
        {/* Static Hacking Icons */}
        <FloatingIcon top="15%" left="15%"><Lock size={20} /></FloatingIcon>
        <FloatingIcon top="25%" left="85%"><TerminalIcon size={20} /></FloatingIcon>
        <FloatingIcon top="45%" left="10%"><Shield size={20} /></FloatingIcon>
        <FloatingIcon top="65%" left="80%"><Database size={20} /></FloatingIcon>
        <FloatingIcon top="75%" left="20%"><Wifi size={20} /></FloatingIcon>
        <FloatingIcon top="35%" left="90%"><Code2 size={20} /></FloatingIcon>
